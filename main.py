                ...
                try {
                    ...
                    if (response.ok) {
                        document.getElementById('message-display').innerHTML = 
                            '<div style="color: green; margin: 15px 0;">✓ Entry added successfully!</div>';
                        e.target.reset();
                        setTimeout(() => location.reload(), 1500);
                    } else {
                        document.getElementById('message-display').innerHTML = 
                            '<div style="color: red; margin: 15px 0;">✗ ' + result.error + '</div>';
                    }
                } catch (error) {
                    document.getElementById('message-display').innerHTML = 
                        '<div style="color: red; margin: 15px 0;">✗ Error submitting entry</div>';
                }
            });
        </script>
    </body>
