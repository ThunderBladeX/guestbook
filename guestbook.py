...
def admin_panel():
    """Admin panel for managing guestbook entries"""
    return '''
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <style>
            ...
            input[type="text"], input[type="password"] { width: 300px; padding: 5px; margin: 10px 0; }
            #admin-key { margin-bottom: 20px; }
            .entry-email { color: #666; font-size: 0.9em; }
        </style>
    </head>
    <body>
        <div class="container">
            ...
            function displayEntries(entries) {
                ...
                entries.forEach(entry => {
                    ...
                    div.innerHTML = `
                        ...
                        <p>${entry.message}</p>
                        ${entry.email ? '<p class="entry-email">Email: ' + entry.email + '</p>' : ''}
